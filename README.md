...
> 当前版本：**7.2.4** · [完整更新日志](CHANGELOG.md) · [GitHub Releases](https://github.com/Xiaowu7z/RR-vps/releases)
...
目标支持系统如下。CI 覆盖三种发行版容器，实际实机范围以当轮发布报告为准。7.2.3 及此前的三机门禁属于历史发布证据；7.2.4 采用用户已批准的三发行版容器 CI 加单机恢复回执核验，未完成的实机项目不得视为通过：

| 系统 | 支持度 | 说明 |
| --- | --- | --- |
| **Debian 12（bookworm）** | ⭐ 主推 | 容器 CI 目标；本次有单机定向恢复回执 |
