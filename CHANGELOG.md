...
- RR Nexus 核心资产固定发布为按版本 Tag 消费的 Prerelease 且禁止争抢 Latest；只有包含完整安装资产的 RR-vps 正式版可成为仓库 Latest，避免 Stable 安装与热更新链接被核心 Release 劫持成 404
...
- 面板版服务于没有 Android 测试环境的用户；Android **CF 域名优选 2.7.1** 已经实际测试，适合移动、电信、联通三网优选，结果可直接使用，是优先推荐的最终优选工具
- Android 2.7.1 本版未改动
